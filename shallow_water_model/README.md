This folder contains a Jupyter notebook to run a shallow water model with pre-defined experiments, as well as some supplemental files.

This python notebook solves the non-linear shallow water equations on a Cartesian beta plane in a channel, with several different options for the model to illustrate a range of meteorological phenomenona.
